...
public class SalesmanWiseSaleAdapter extends BaseAdapter {
	
	private Context context;
	private List<Sale> sales;
	private String route;
	
	public SalesmanWiseSaleAdapter(Context context, List<Sale> sales, String route) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.salesman_wise_sale_list_item, null);
		}
